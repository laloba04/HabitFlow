export default function Footer() {
  return (
    <footer id="footer" className="relative py-12 border-t border-white/5">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="flex justify-center gap-6">
            ...
            <a
              href="https://www.linkedin.com/in/maria-bravo-angulo-363133337/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-dark-400 hover:text-primary-400 transition-colors duration-300"
              aria-label="LinkedIn"
          ...
          <div className="text-right">
            <p className="text-dark-400 text-sm">
              © 2026 <span className="text-dark-300">María Bravo Angulo</span>
            </p>
          </div>
        </div>
      </div>
